...
namespace mprpc {
PROTOBUF_CONSTEXPR MprpcHeader::MprpcHeader(
...
struct MprpcHeaderDefaultTypeInternal {
  PROTOBUF_CONSTEXPR MprpcHeaderDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~MprpcHeaderDefaultTypeInternal() {}
  union {
    MprpcHeader _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 MprpcHeaderDefaultTypeInternal _MprpcHeader_default_instance_;
}  // namespace mprpc
...
const uint32_t TableStruct_mprpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::mprpc::MprpcHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::mprpc::MprpcHeader, _impl_.service_name_),
  PROTOBUF_FIELD_OFFSET(::mprpc::MprpcHeader, _impl_.method_name_),
  PROTOBUF_FIELD_OFFSET(::mprpc::MprpcHeader, _impl_.args_size_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::mprpc::MprpcHeader)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::mprpc::_MprpcHeader_default_instance_._instance,
};
...
const ::_pbi::DescriptorTable descriptor_table_mprpcheader_2eproto = {
    false, false, 111, descriptor_table_protodef_mprpcheader_2eproto,
    "mprpcheader.proto",
...
class MprpcHeader::_Internal {
 public:
};

MprpcHeader::MprpcHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:mprpc.MprpcHeader)
}
MprpcHeader::MprpcHeader(const MprpcHeader& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  MprpcHeader* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
inline void MprpcHeader::SharedCtor(
...
inline void MprpcHeader::SharedDtor() {
...
// @@protoc_insertion_point(message_clear_start:mprpc.MprpcHeader)
...
const char* MprpcHeader::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
uint8_t* MprpcHeader::_InternalSerialize(
...
size_t MprpcHeader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:mprpc.MprpcHeader)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData MprpcHeader::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    MprpcHeader::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*MprpcHeader::GetClassData() const { return &_class_data_; }


void MprpcHeader::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<MprpcHeader*>(&to_msg);
  auto& from = static_cast<const MprpcHeader&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:mprpc.MprpcHeader)
...
// @@protoc_insertion_point(class_specific_copy_from_start:mprpc.MprpcHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void MprpcHeader::InternalSwap(MprpcHeader* other) {
  using std::swap;
...
::PROTOBUF_NAMESPACE_ID::Metadata MprpcHeader::GetMetadata() const {
...
template<> PROTOBUF_NOINLINE ::mprpc::MprpcHeader*
Arena::CreateMaybeMessage< ::mprpc::MprpcHeader >(Arena* arena) {
  return Arena::CreateMessageInternal< ::mprpc::MprpcHeader >(arena);
}
